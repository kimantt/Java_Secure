...
import java.util.random.*; // 암호학적으로 충분한 난수를 추출하지 않음. 암호화 진행 시 사용제한
import java.security.SecureRandom; // 암호화 시 사용권장
...
public class MemberJoinKeySalt {
	...
	public static String getSalt() throws Exception {
		...
		return Byte_to_String(temp); // 문자열 salt가 반환됨
	}
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			String memSalt = getSalt(); // 회원 개인별 salt값 저장해야함
